...
The `Thing`, designed as a starter kit for IoT initiatives, provides a solid and structured platform to speed up the product development. The  [starter kit concept](https://www.codeproject.com/Articles/1122233/IoT-Starter-Core-for-Netduino-Plus) encourages the teams to start working immediately on the product development.
