...
Following the API first strategy, a new [API version 1.0.2](https://app.swaggerhub.com/apis/motta/home/1.0.2) is created and summarized at picture below, showing a new `RemoteApi` controller. The `GET` operations should identify remotes and their respective IR codes. The `POST` operation reflects the intention to fire IR blasts for remotes already installed at RPI host, using Lirc software.     
