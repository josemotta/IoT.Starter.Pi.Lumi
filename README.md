...
Depending on your application obejctives, you should now  develop a custom `home-ui` project that handles the user interface, using RemoteApi as starting point!
