...
At this mission, we improved the API to a new version adding infrared  support to the `Thing` device. SwaggerHub automatically generated the changes for us, adding a new Controller that was merged to `home-web` project.
